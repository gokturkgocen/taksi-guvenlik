...
ölçtüğü değerlerden hesaplanmıştır. Bölüm~\ref{tab:results-latency} kategori
...
Bölüm~\ref{ch:gerceklestirme}'de tanımlanan \texttt{far\_frr.py} aracı,
