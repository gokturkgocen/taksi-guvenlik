...
Android'in \texttt{Intent.ACTION\_CALL("tel:155")} yöntemi, ek kullanıcı
etkileşimi olmaksızın çağrı başlatabilen tek mobil API hattıdır; iOS
sandbox ortamı, kullanıcı onayı olmadan bu çağrıyı engellemektedir
\cite{android2024telephony}. Bu nedenle hedef platform Android olarak
belirlenmiştir.
