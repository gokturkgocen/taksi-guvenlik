...
% ------------------------------ Kapak ------------------------------------
\input{chapters/00_kapak}

% ------------------------------ Önsöz / Özet -----------------------------
% \frontmatter
\pagenumbering{roman}

\input{chapters/00_onsoz}
\input{chapters/00_ozet}
...
\input{chapters/01_giris}
\input{chapters/02_literatur}
\input{chapters/03_yontem}
\input{chapters/04_gerceklestirme}
\input{chapters/05_sonuclar}
\input{chapters/06_sonuc_ve_oneriler}
...
% ------------------------------ Ekler ------------------------------------
\appendix
\input{chapters/ek_a_protokol}
\input{chapters/ek_b_pin_plani}
